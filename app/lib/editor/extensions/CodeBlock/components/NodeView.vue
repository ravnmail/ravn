...
class="echo-code-block-toolbar">
        <TooltipProvider :delay-duration="0">
          <Tooltip>
            ...
            <TooltipContent :side-offset="5">{{ t('composer.codeblock.selectLang') }}</TooltipContent>
          </Tooltip>
        </TooltipProvider>
...
name="lucide:copy"/>
            ...
            <TooltipContent :side-offset="5">{{ t('composer.codeblock.copy') }}</TooltipContent>
          </Tooltip>
        </TooltipProvider>
...
name="lucide:list"/>
            ...
            <TooltipContent :side-offset="5">{{ t('composer.codeblock.lineNumbers') }}</TooltipContent>
          </Tooltip>
        </TooltipProvider>
          ...
          <Tooltip>
            <TooltipTrigger>
              ...
              >
                <Icon
class="w-4 h-4"
name="lucide:wrap-text"/>
              </div>
            </TooltipTrigger>
            <TooltipContent :side-offset="5">{{ t('composer.codeblock.wordWrap') }}</TooltipContent>
          </Tooltip>
        </TooltipProvider>
...
name="lucide:indent-increase" />
            ...
            <TooltipContent :side-offset="5">{{ t('composer.codeblock.tabSize') }}</TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
    </div>
